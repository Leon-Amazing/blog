...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    // 修改的
    const cover = (() => this.$themeConfig.covers[new Date().getDay()] || "https://pan.zealsay.com/zealsay/cover/1.jpg")
    const pageCover = (() => this.$page.frontmatter.cover || this.$themeConfig.covers[new Date().getDay()] || "https://pan.zealsay.com/zealsay/cover/1.jpg")
